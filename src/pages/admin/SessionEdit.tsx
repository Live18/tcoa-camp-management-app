...
const SessionEdit = () => {
  ...
  const isClassroomSession = window.location.pathname.includes("classroom-sessions");
      ...
      <div className="container mx-auto py-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
          <div>
            ...
            <h1 className="text-3xl font-bold">Edit {isClassroomSession ? "Classroom " : ""}Session</h1>
          </div>
        </div>
